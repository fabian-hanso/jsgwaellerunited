...
export default function SocialCampagne() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 text-left">
          <img
            src="/SocialBackground.jpg"
            alt=""
          ...
          <p className="mt-6 max-w-xl text-pretty text-lg/8 text-white italic">
            Hol dir die wichtigsten Updates - regelmäßig und vor allem kostenlos direkt auf dein Handy.
          </p>
