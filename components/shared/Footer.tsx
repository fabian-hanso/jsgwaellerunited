...
const navigation = {
  ...
  company: [
    { name: 'Revice Media', href: '#' },
    { name: 'Trade Republic', href: '#' },
  ],
  legal: [
    { name: 'Impressum', href: '#' },
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="border-t border-gray-900/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-950">Mannschaften</h3>
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-gray-950">Quicklinks</h3>
                <ul role="list" className="mt-6 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-950">Partner</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-12 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0">
            &copy; 2026 JSG Wäller United - Revice Media
          </p>
        </div>
      </div>
    </footer>
